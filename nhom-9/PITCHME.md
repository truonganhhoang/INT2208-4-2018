...
- Nhưng nó lại tồn tại rất nhiều vấn đề như:
 ...
 1) Cần phải tìm ra làm thế nào để đặt tên cho điều bạn sẽ gọi

 2) ...để định dạng các thông số mà bạn muốn vượt qua điều đó

 3) ...cách định dạng thẻ *return*- giá trị của nó sẽ trở lại từ *remote host*...
---
